...
# Extraire uniquement l'heure de la colonne Fecha
datos_completos$Hora <- format(as.POSIXct(strptime(datos_completos$Fecha, "%d/%m/%Y %H:%M")), format = "%H:%M")

# Affiche des premières lignes pour vérification
...
# Créer un histogramme des achats par heure
ggplot(df_fre_compras, aes(x = Hora, y = Frequencia)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "black") +
  labs(title = "Distribution des achats par heure",
       x = "Hora",
       y = "Número de compras")
```
